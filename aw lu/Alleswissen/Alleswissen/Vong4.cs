...
{
    public partial class Vong4 : Form
    {
        ...
        private void Vong4_Load(object sender, EventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (prev_cau!= cau)
            {
                ...
                if (goi == 40)
                {
                    if (cau % 3 == 0) refill(15); else refill(10);
                }
                else if (goi == 60)
                {
                    if (cau % 3 == 0)
            ...
            {
                bell.Visible = true;
                bell.Text = "Đội " + bellon + " đã nhấn chuông";
            }
            else
            {
                bell.Visible = false;
